...
public class CacheManager implements ICacheAccess<CacheKey, CacheObject> {
    ...
    public void setup() {
        ...
        props.put("jcs.auxiliary.DC", IndexedDiskCacheFactory.class.getName());
        props.put("jcs.auxiliary.DC.attributes", IndexedDiskCacheAttributes.class.getName());
        props.put("jcs.auxiliary.DC.attributes.DiskPath", "jcs_swap");
